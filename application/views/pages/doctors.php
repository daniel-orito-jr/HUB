        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-7 col-sm-12">
                ...
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Doctors'); ?>">Management</a></li>
            ...
            <div class="col-md-12">
                <div class="card patients-list">
                    <div class="header">
                        ...
                        <button type="button" class="btn btn-primary btn-round waves-effect float-right" style='margin-left:70%;' onclick='showAddDoctorsModal()'><i class="zmdi zmdi-plus"></i>&nbsp;&nbsp;<b>NEW DOCTOR</b></button>
                    ...
                    <div class="body">
                        ...
                        <div class="tab-content m-t-10">
                            <div class="tab-pane table-responsive active" id="All">
                                <table class="table table-bordered table-striped table-hover" id="doctors-masterlist-table" style='width:100%;'>
                                    <thead>
                                        <tr>                                       
                                            <th>Action</th>
                                            <th>Last&nbsp;&nbsp;Name</th>
