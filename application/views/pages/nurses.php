    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-5 col-sm-12">
                <h2>Nurses Management
                    <small class="text-muted"><?= $hosp_name['compname'] ?></small>
                </h2>
            </div>
            <div class="col-lg-5 col-md-7 col-sm-12">
                <!--                <button class="btn btn-primary btn-icon btn-round d-none d-md-inline-block float-right m-l-10" type="button" onclick="showAddNursesModal();">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card patients-list">
                    <div class="header">
                        <h2><strong>Nurses</strong> List</h2>
                        <button type="button" class="btn btn-primary btn-round waves-effect float-right" style='margin-left:70%;' onclick='showAddNursesModal()'><i class="zmdi zmdi-plus"></i>&nbsp;&nbsp;<b>NEW NURSE</b></button>
                    ...
                    <div class="body">
                        ...
                        <div class="tab-content m-t-10">
                            <div class="tab-pane table-responsive active" id="All">
                                <table class="table table-bordered table-striped table-hover" id="nurses-masterlist-table">
                                    <thead>
                                        <tr>                                       
                                            <th>Action</th>
                                            <th>Code</th>
