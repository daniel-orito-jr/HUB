<div class="modal fade" id="outpatientlistforrxcreator" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="margin-bottom:0px;margin-top:7px;padding-bottom:0px;padding-top:0px;padding-left:15px;padding-right:15px">
                <h4 class="title" id="largeModalLabel">OutPatient Management Console</h4>
            </div>
<!--            <div class="modal-body" style="margin-bottom:0px;margin-top:0px;padding-bottom:0px;padding-top:0px;">
            ...
            <div class="row" id="diagnosis-button" style="margin-bottom:0px;margin-top:0px;padding-bottom:0px;padding-top:0px;padding-left:3px;padding-right:3px;margin-left:0px;margin-right:0px;">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <button type="button" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 btn btn-primary waves-effect" onclick="alert('Under Development')"><i class="zmdi zmdi-plus"></i><b>&nbsp;&nbsp;ADD NEW OPD PATIENT</b></button>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <button type="button" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 btn btn-success waves-effect" onclick="alert('Under Development')"><i class="zmdi zmdi-plus-square"></i><b>&nbsp;&nbsp;MEDICAL CONSULTATIONS</b></button>
                </div>
            </div>
            <div class="" id="diagnosis-table" style="margin-bottom:0px;margin-top:0px;padding-bottom:0px;padding-top:0px;padding-left:20px;padding-right:20px;">
                <table class="table table-bordered" id="outpatient-masterlist-table">
                    <thead>
                        <tr>                                       
                            <th id="table-head-action2sl">Action</th>
                            <th id="table-head-name">Patient&nbsp;&nbsp;&nbsp;Name</th>
                            <th id="table-head-action2">Patient&nbsp;&nbsp;&nbsp;No.</th>
                            <th id="table-head-namediag">Index&nbsp;&nbsp;&nbsp;Card&nbsp;&nbsp;&nbsp;No.</th>
                            <th id="table-head-name">Birthday</th>
                            <th id="table-head-name">Gender</th>
                            <th id="table-head-name">Address</th>
                            <th id="table-head-name">City/Mun.</th>
                            <th id="table-head-name">ID</th>
                            <th id="table-head-name">Doctor&nbsp;&nbsp;&nbsp;Name</th>
                            <th id="table-head-name">Doctor&nbsp;&nbsp;&nbsp;Ref.</th>
                            <th id="table-head-name">Updated</th>
                            <th id="table-head-name">Member&nbsp;&nbsp;&nbsp;ID</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="modal-footer" id="diagnosis-footer" style="margin-bottom:20px;margin-top:0px;padding-bottom:0px;padding-top:0px;">
                <button type="button" class="btn btn-default waves-effect" onclick="hideOutpatientMasterlistForRxCreatorMaker()">CLOSE</button>
                <button type="button" id='savebutton' class="btn btn-info waves-effect" onclick="selectOutPatientForRXCreatorMaker()">SELECT</button>
            </div>
        </div>
    </div>
</div>
