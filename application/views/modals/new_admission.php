<div class="modal fade" id="newadmissionmodal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;margin:0px;">
            <div class="modal-header" style="padding-left:20px;padding-right:0px;padding-top:10px;padding-bottom:10px;margin:0px;">
                <h4 class="title" id="largeModalLabel">&nbsp;New Admission</h4>
            </div>
            <div class="modal-body" style="padding-bottom:0px;padding-top:0px;margin-bottom:0px;margin-top:0px">
                <div class="tab-pane" id="All">
                    ...
                    <table class="table table-bordered table-hover" id="search-allpatient-table">
                        <thead>
                            <tr>                                       
                                <th id="table-head-actionpac2">Action</th>
                                <th id="table-head-descmgh">Name</th>
            ...
            <div class="modal-footer">
                <button class="" disabled id="transparentbg">CLOSE</button>
                <button type="button" class="btn btn-default waves-effect" onclick="hideNewAdmissionModal()">CLOSE</button>
            </div>
        </div>
    </div>
</div>
