<div class="modal fade" data-refresh="true" id="searchhcilistingmodal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="margin-bottom:0px;margin-top:7px;padding-bottom:0px;padding-top:0px;padding-left:15px;padding-right:15px">
                <h4 class="title" id="largeModalLabel">Health Care Institutions Management</h4>
            </div>
<!--            <div class="modal-body" style="margin-bottom:0px;margin-top:0px;padding-bottom:0px;padding-top:0px;">
            ...
            <div class="row" id="diagnosis-button" style="margin-bottom:0px;margin-top:0px;padding-bottom:0px;padding-top:0px;padding-left:30px;padding-right:30px;">
                <button type="button" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 btn btn-primary waves-effect" onclick=""><i class="zmdi zmdi-plus"></i><b>&nbsp;&nbsp;NEW HEALTH CARE INSTITUTION</b></button>
            </div>
            <div class="" id="diagnosis-table" style="margin-bottom:0px;margin-top:0px;padding-bottom:0px;padding-top:0px;padding-left:20px;padding-right:20px;">
                <table class="table table-bordered" id="hcilisting-masterlist-table">
                    <thead>
                        <tr>                                       
                            <th id="table-head-action2sl">Action</th>
                            <th id="table-head-name">Health&nbsp;&nbsp;Care</th>
                            <th id="table-head-name">Ref.No.</th>
                            <th id="table-head-desc">Address</th>
                            <th id="table-head-action">PAN</th>
                            <th id="table-head-action">Level</th>
                            <th id="table-head-action">Type</th>
                            <th id="table-head-name">CEO/President</th>
                            <th id="table-head-name">Official&nbsp;&nbsp;Capacity</th>
            ...
            <div class="modal-footer" id="diagnosis-footer" style="margin-bottom:20px;margin-top:0px;padding-bottom:0px;padding-top:0px;">
                <button type="button" class="btn btn-default waves-effect" onclick="hideHCIListingModalForMGHClearance()">CLOSE</button>
                <button type="button" id='savebutton' class="btn btn-info waves-effect" onclick="selectHealthCareInstitutionForMGHClearanceForm()">SELECT</button>
            </div>
        </div>
    </div>
</div>