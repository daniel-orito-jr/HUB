<body class="theme-cyan menu_img">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img class="zmdi-hc-spin" src="<?= base_url('assets/images/logo.png'); ?>" width="48" height="48" alt="Drainwiz"></div>
            <p>Please wait...</p>        
        </div>
    </div>
        ...
        <ul class="nav navbar-nav navbar-left">
            <li>
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href=""><img src="<?= base_url('assets/images/logo.png'); ?>" width="30" alt="Drainwiz"><span class="m-l-10">Drainwiz</span></a>
                </div>
            </li>
            <li><a href="javascript:void(0);" class="ls-toggle-btn toggled" data-close="true"><i class="zmdi zmdi-swap"></i></a></li>
            ...
            <li><a href="<?= base_url('Patients'); ?>" target="_blank" title="Patient List"  ><i class="zmdi zmdi-account-box-phone"></i></a></li>
            ...
            <li class="d-none d-md-inline-block col-md-5" style="color:white;">
                	<div class="btn-group bootstrap-select form-control z-index show-tick">      
                            
                    <select class="form-control z-index show-tick" data-live-search="true" id="cmb-select-patient" onchange="globaljs.getpxinfo()">
                        <option style="background: rgba(0, 0, 0, 0.2);color: black;" value="All">- Select Patient -</option>
                        <?php for($i=0;$i<count($allpx);$i++)
                        {
                            echo "<option style='background: rgba(0, 0, 0, 0.2);color: black;' value='".$allpx[$i]["PIN"]."'  >".$allpx[$i]["PIN"]." - ".substr($allpx[$i]["name"],0,20)."</option>";
                        }?>
                    </select>
            ...
            <li class="float-right">
                <a href="<?= base_url('Login/sign_out') ?>" title="Log out" class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a>
            ...
            <div class="tab-pane stretchRight active" id="dashboard">
                <div class="menu">
                    <ul class="list">
                        <li>
                            <div class="user-info">
                                <div class="image"><a href="<?= base_url('Dashboard'); ?>"><img src="<?= base_url('assets/images/profile_luffy.png') ?>" alt="User"></a></div>
                                <div class="detail">
                                    <h4><?= $this->session->userdata('empname') ?></h4><input id="name_login" value="<?= $this->session->userdata('empname') ?>" hidden/>
                                    <small><?= $this->session->userdata('jobposition') ?></small>                        
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="" id="dashbrdsidetab"><a href="<?= base_url('Dashboard'); ?>"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>            

                        <li class="" id="patientsidetab"><a href="javascript:void(0);" id="patientanchor" class="menu-toggle"><i class="zmdi zmdi-face"></i><span>Patients</span> </a>
                            <ul class="ml-menu">
                                <li class="" id="allpxliid"><a href="<?= base_url('Patients'); ?>">All Patients</a></li>
                                <li class="" id="admitliid"><a href="<?= base_url('Admission'); ?>">Admission</a></li>                       
                                <li class="" id="dischliid"><a href="<?= base_url('Discharges'); ?>">Discharges</a></li>
                            </ul>
                        </li>
                        
<!--                        <li class="" id="managesidetab"><a href="javascript:void(0);" id="manageanchor" class="menu-toggle"><i class="zmdi zmdi-wrench"></i><span>Management</span> </a>
                            <ul class="ml-menu">
                                <li class="" id="doctrliid"><a href="<?= base_url('Doctors'); ?>">Doctor Management</a></li>
                                <li class="" id="nurseliid"><a href="<?= base_url('Nurses'); ?>">Nurses Management</a></li>                       
                                <li class="" id="roomsliid"><a href="<?= base_url('Rooms'); ?>">Rooms Management</a></li>
                                <li class="" id="packaliid"><a href="<?= base_url('Packages'); ?>">Packages Manager</a></li>
                            </ul>
                        </li>-->
                        
                        <li class="" id="emergencysidetab"><a href="<?= base_url('Emergency'); ?>"><i class="zmdi zmdi-hospital"></i><span>Emergency</span> </a></li>
                        
                        <li class="" id="mghclearancesidetab"><a href="<?= base_url('MGHclearance'); ?>"><i class="zmdi zmdi-check-square"></i><span>MGH Clearance</span> </a></li>
                        
                        <!--<li class="" id="rxcreatormkrsidetab"><a href="<?= base_url('RXcreatormaker'); ?>"><i class="zmdi zmdi-widgets"></i><span>RX Creator/Maker</span> </a></li>-->
                        
                        <!--<li class="" id="homeinstructsidetab"><a href="<?= base_url('HomeInstruction'); ?>"><i class="zmdi zmdi-airline-seat-recline-normal"></i><span>Home Instructions</span> </a></li>-->
                        
                        <!--<li class="" id="eropdchargessidetab"><a href="<?= base_url('EROPDcharges'); ?>"><i class="zmdi zmdi-hospital-alt"></i><span>E.R. OPD Charges</span> </a></li>-->
                        
<!--                        <li class="" id="viewresultsidetab"><a href="javascript:void(0);" id="viewresultanchor" class="menu-toggle"><i class="zmdi zmdi-assignment-o"></i><span>View Results</span> </a>
                            <ul class="ml-menu">
                                <li class="" id="labresultliid"><a href="<?= base_url('LaboratoryResults'); ?>">Laboratory Results</a></li>                       
                                <li class="" id="radresultliid"><a href="<?= base_url('RadiologyResults'); ?>">Radiology Results</a></li>
                            </ul>
                        </li>-->
                        
                        <!--<li class="" id="admissiondashboardsidetab"><a href="<?= base_url('AdmissionDboard'); ?>"><i class="zmdi zmdi-developer-board"></i><span>Patient Dashboard</span> </a></li>-->
                        
<!--                        <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-balance-wallet"></i><span>Request & Returns</span> </a>
                            <ul class="ml-menu">
                                <li><a href="javascript:void(0);">Payments</a></li>
                                <li><a href="javascript:void(0);">Add Payment</a></li>
                        ...
                        <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-label-alt"></i><span>Departments</span> </a>
                            <ul class="ml-menu">
                                ...
                                <li><a href="javascript:void(0);">Medical Records</a></li>
                                <li><a href="javascript:void(0);">PhilHealth</a></li>
                                <li><a href="javascript:void(0);">Business Office</a></li>
                                <li><a href="javascript:void(0);">Cashiering</a></li>
                                <li><a href="javascript:void(0);">HMO</a></li>
                        ...
                        <li class="" id="cf4managersidetab"><a href="<?= base_url('CF4Mgmt'); ?>"><i class="zmdi zmdi-calendar"></i><span>CF4 Management</span> </a></li>
                        
                        <li class="header">EXTRA COMPONENTS</li>
                        
                        <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-blogger"></i><span>Blog</span></a>
                            <ul class="ml-menu">
                                <li><a href="javascript:void(0);">Blog Dashboard</a></li>
                        ...
                        <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>File Manager</span> </a>
                            <ul class="ml-menu">
                                <li><a href="javascript:void(0);">All File</a></li>
                        ...
                        <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-delicious"></i><span>Widgets</span> </a>
                            <ul class="ml-menu">
                                <li><a href="javascript:void(0);">Apps Widgetse</a></li>
                                <li><a href="javascript:void(0);">Data Widgetse</a></li>
                            </ul>
                        </li>       
                        ...
                        <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-copy"></i><span>Sample Pages</span> </a>
                            <ul class="ml-menu">
                                ...
                                <li><a href="javascript:void(0);">RTL Support</a></li>
                        ...
                        <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>User Interface (UI)</span> </a>
                            <ul class="ml-menu">
                                ...
                                <li><a href="javascript:void(0);">Collapse</a></li>
                                <li><a href="javascript:void(0);">Colors</a></li>
                                <li><a href="javascript:void(0);">Dialogs</a></li>
                                <li><a href="javascript:void(0);">Icons</a></li>
                                <li><a href="javascript:void(0);">List Group</a></li>
                                <li><a href="javascript:void(0);">Media Object</a></li>
                                ...
                                <li><a href="javascript:void(0);">Sortable & Nestable</a></li>
                                <li><a href="javascript:void(0);">Tabs</a></li>
                                <li><a href="javascript:void(0);">Waves</a></li>
                            </ul>
                        </li>
                    ...
                    <ul class="list">
                        <li>
                            <div class="user-info m-b-20 p-b-15">
                                <div class="image"><a href="profile.html"><img src="<?= base_url('assets/images/profile_av.jpg') ?>" alt="User"></a></div>
                                <div class="detail">
                                    <h4>Dr. Charlotte</h4>
                ...
                <div class="slim_scroll">
                    <div class="card user_activity">
                        ...
                        <div class="streamline b-accent">
                            <div class="sl-item">
                                <img class="user rounded-circle" src="<?= base_url('assets/images/xs/avatar4.jpg'); ?>" alt="">
                            ...
                            <div class="sl-item">
                                <img class="user rounded-circle" src="<?= base_url('assets/images/xs/avatar5.jpg'); ?>" alt="">
                                <div class="sl-content">
                            ...
                            <div class="sl-item">
                                <img class="user rounded-circle" src="<?= base_url('assets/images/xs/avatar6.jpg'); ?>" alt="">
                                <div class="sl-content">
                            ...
                            <div class="sl-item">
                                <img class="user rounded-circle" src="<?= base_url('assets/images/xs/avatar7.jpg'); ?>" alt="">
                                <div class="sl-content">
