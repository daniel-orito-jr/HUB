...
require_once('//192.168.2.111/htdocs/HUBv19/application/libraries/JavaBridge/webapps/JavaBridge/java/Java.inc');
...
class Javabridge {
    ...
    public function load_manager($type) {
        ...
        } else if ($type === "largerdata") {
            $javaclass = new JavaClass("net.sf.jasperreports.engine.export.JRPdfExporter");
        }
    ...
    public function load_export_parameter() {
        $jreexporterparam = java("net.sf.jasperreports.engine.JRExporterParameter");

        return $jreexporterparam;
    }
